...
snapshots["test_great_expectations_parsing 1"] = {
    ...
    "_build_intro_string": set(
        ["great_expectations/cli/docs.py", "great_expectations/cli/v012/docs.py"]
    ),
    ...
    "_get_full_path_to_ge_dir": set(
        ["great_expectations/cli/init.py", "great_expectations/cli/v012/init.py"]
    ),
    ...
    "build_docs": set(
        ["great_expectations/cli/v012/docs.py", "great_expectations/cli/build_docs.py"]
    ),
    ...
    "cli": set(["great_expectations/cli/cli.py", "great_expectations/cli/v012/cli.py"]),
    ...
    "main": set(
        ["great_expectations/cli/cli.py", "great_expectations/cli/v012/cli.py"]
    ),
...
snapshots["test_great_expectations_parsing 4"] = {
    ...
    "great_expectations/datasource/simple_sqlalchemy_datasource.py": set(
        ["tests/data_context/test_data_context.py", "tests/cli/test_checkpoint.py"]
    ),
    "great_expectations/datasource/sparkdf_datasource.py": set(
        [
            "tests/datasource/test_sparkdf_datasource.py",
